...
```{r}
df <- readxl::read_excel("data/Gender-equality-index.xlsx")
...
df <- readxl::read_excel("data/Gender-equality-index.xlsx", sheet = 3)

df %>%
  janitor::clean_names() %>% 
  pivot_longer(-c(index_year:gender_equality_index)) %>% view
```
