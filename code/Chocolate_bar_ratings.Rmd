...
First we will call the tidyverse meta pacakge - a cohesive group of packages that make working with messy data very easy - originally coined by Hadley Wickham but improved upon by a great many contributors. I'll leave a link in the description to more info about this.
